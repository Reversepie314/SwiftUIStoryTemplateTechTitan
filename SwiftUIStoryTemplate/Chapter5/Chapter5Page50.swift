...
struct Chapter5Continued: View {
    var body: some View {
            ...
            Text("Conclusion")
              ...
              VStack {
            Text("Our friends have returned to town to face the evil darkness, Alex and the gang have gained the power to defeat the dark entity.")
            
            Text("As the battle with the Shadowlord concluded, and the darkness receded, the five friends stood amidst the now-peaceful forest, their hearts still racing from the intensity of the struggle. The weight of their heroic actions hung in the air, and a sense of accomplishment filled their hearts.")
            
            Text("A sign of relief, our heroes' journey has concluded.")
            Text("Lily, the group's gifted healer, broke the silence with a gentle smile. 'We did it,' she said, her eyes filled with gratitude. 'We've not only saved Everwood, but the entire world.'")
            
            Text("Max, who possessed a deep connection with nature, nodded in agreement. 'And we did it together. The bond we've formed is unbreakable.'")
            
            Text("Mia, the skilled archer, turned to Jake, the fearless warrior, and said, 'Jake, your bravery in the face of danger was truly inspiring.'")
            
            Text("Jake grinned and clapped a hand on Alex's shoulder, the brilliant strategist of the group. 'And Alex, your plans and wisdom guided us to victory. We couldn't have done it without you.'")
            //
